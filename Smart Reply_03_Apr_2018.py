...
def load_vocab(self):
    ...
    inp_model = word2vec.Word2Vec(inp_sentences, iter=5, min_count=5, size=100, workers=4)
    out_model = word2vec.Word2Vec(out_sentences, iter=5, min_count=5, size=100, workers=4)
...
class CornellWordGloveChatBot(object):
    ...
    def reply(self, input_text):
        ...
        target_seq[0, 0, :] = self.word2em_output['start']
