...
def load_vocab(inp_clean_corpus):
    ...
    model = word2vec.Word2Vec(sentences, iter=5, min_count=10, size=10, workers=4)
...
def read_input():
    ...
    return vocab, input_texts, target_texts, target_counter
...
class CornellWordGloveChatBot(object):
    ...
    def __init__(self):
        ...
        self.word2em, self.input_texts, self.target_texts, self.target_counter = read_input()
